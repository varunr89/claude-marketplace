...
| copilot-collab | Automated GitHub Copilot CLI reviews and interactive consultations via Stop hooks |
...
| call | Automated phone calls from Claude Code — voicemail, IVR navigation, and warm transfer |
